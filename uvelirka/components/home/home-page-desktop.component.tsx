...
export default function HomePageDesktopComponent({ primaryCatalogs }: IHomePageDesktopComponentProps) {
  ...
  return <div>
    ...
    <div className={styles.secondarycatalogs}>
      ...
      {primaryCatalogs.slice(0, 6).map(catalog =>
        <SecondaryCatalog key={catalog._id}
    ...
    <div className={styles.primarycatalogs}>
      <CatalogList className={styles.cataloglist}
